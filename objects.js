...
console.log('Hoi! Ik ben '+ introducing.firstName +', ik ben '+ introducing.age + ' jaar oud' );
...
const nameDescription = ['De ' + product.productName + ' is gemaakt van ' + product.material[0] + product.material[1]]
